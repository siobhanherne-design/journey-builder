    ...
    <div className="h-[56px] bg-white border-b border-[#e5e7f0] flex items-center justify-between px-5 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="px-4 py-1.5 text-[13px] font-medium text-[#1a1b2e] border border-[#e5e7f0] rounded-md hover:bg-[#1a1b2e] hover:text-white transition-colors flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#4f46e5]/30"
        >
        ...
        <div className="relative" ref={saveMenuRef}>
          <button
            ...
            className="px-4 py-1.5 text-[13px] font-medium text-white bg-[#4f46e5] rounded-md hover:bg-[#4338ca] transition-colors flex items-center gap-2"
          >
            Save
